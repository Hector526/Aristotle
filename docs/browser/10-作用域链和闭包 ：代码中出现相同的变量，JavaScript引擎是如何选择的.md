...
![执行 bar 函数时的调用栈](./img/87d8bbc2bb62b03131802fba074146f7.webp)
...
![带有外部引用的调用栈示意图](./img/20a832656434264db47c93e657e346a7.webp)
...
![词法作用域](./img/216433d2d0c64149a731d84ba1a07739.webp)
...
![块级作用域中是如何查找变量的](./img/25053af5ae30c8be991fa14631cde0a7.webp)
...
![执行到 return bar 时候的调用栈](./img/d5587b76427a56c5f0b0571e4264b7ef.webp)
...
![闭包的产生过程](./img/ee7c1ca481875ad4bdeb4383bd1f883f.webp)
...
![执行 bar 时调用栈状态](./img/50e4ba60fc7e420e83b35b95e379b246.webp)
...
![开发者工具中的闭包展示](./img/40b8840480a5df4f43ad5f4e7907e3a8.webp)
