...
![字节流转换为 DOM](./img/1bfcd419acf6402c20ffc1a5b1909d8c.webp)
...
![生成的 Token 示意图](./img/b16d2fbb77e12e376ac0d7edec20ceac.webp)
...
![解析到 StartTag html 时的状态](./img/7a6cd022bd51a3f274cd994b1398bef1.webp)

然后按照同样的流程解析出来 StartTag body 和 StartTag div，其 Token 栈和 DOM 的状态如下图所示：

![解析到 StartTag div 时的状态](./img/8c7ba966cebb0050b81c0385ffb4f2a5.webp)

接下来解析出来的是第一个 div 的文本 Token，渲染引擎会为该 Token 创建一个文本节点，并将该 Token 添加到 DOM 中，它的父节点就是当前 Token 栈顶元素对应的节点，如下图所示：

![解析出第一个文本 Token 时的状态](./img/dc0ddd4e3bf3569555f4b1ebec7a8caf.webp)

再接下来，分词器解析出来第一个 EndTag div，这时候 HTML 解析器会去判断当前栈顶的元素是否是 StartTag div，如果是则从栈顶弹出 StartTag div，如下图所示：

![元素弹出 Token 栈示意图](./img/c4a255a8881ef9d21e419aa010ce24a6.webp)

按照同样的规则，一路解析，最终结果如下图所示：

![最终解析结果](./img/aabf14cde38b058c5203195db82ec22e.webp)
...
![执行脚本时 DOM 的状态](./img/4150e27b332fab9f5a10bfafb524ff54.webp)
