...
![开始执行 showName 函数时的调用栈](./img/944aaeaeb9ee50feea3c7d218acdd5c9.webp)
...
![varTest 函数的执行上下文](./img/4501368679083f3a8e1a9e4a8e316dbf.webp)
...
![f9f67f2f53437218baef9dc724bd4c67](./img/f9f67f2f53437218baef9dc724bd4c67.webp)
...
![执行 foo 函数内部作用域块时的执行上下文](./img/7e0f7bc362e0dea21d27dc5fb08d06fa.webp)
...
![变量查找过程](./img/06c06a756632acb12aa97b3be57bb908.webp)

从上图你可以清晰地看出变量查找流程，不过要完整理解查找变量或者查找函数的流程，就涉及到作用域链了，这个我们会在下篇文章中做详细介绍。

当作用域块执行结束之后，其内部定义的变量就会从词法环境的栈顶弹出，最终执行上下文如下图所示：

![作用域执行完成示意图](./img/d4f99640d62feba4202aa072f6369d28.webp)
...
所以说，语言本身好坏不重要，重要的是能为开发者创造价值。思考时间
