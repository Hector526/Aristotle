...
![David 域名被盗流程](./img/3d7f097b1d6a8f93a960a12892f1556b.webp)
...
以上就是 David 的域名被盗的完整过程，其中前两步就是我们今天要聊的 CSRF 攻击。David 在要回了他的域名之后，也将整个攻击过程分享到他的站点上了，如果你感兴趣的话，可以参考该链接（`https://www.davidairey.com/google-gmail-security-hijack`）（放心这个链接是安全的）。
...
![HTTP 请求头中的 Referer 引用](./img/159430e9d15cb7bcfa4fd014da31a2c9.webp)
...
![258dc5542db8961aaa23ec0c02030003](./img/258dc5542db8961aaa23ec0c02030003.webp)
