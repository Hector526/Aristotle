...
![任务和消息队列](./img/fa9f5853a5dcad650aaaf39072820ef4.webp)
...
![队头阻塞问题](./img/cc7c32fa82207cece9c78015e4b841ff.webp)
...
![引入高优先级的消息队列](./img/039fdf4c399d20a75d7dea9448cc8fc1.webp)
...
![增加多个不同优先级的消息队列](./img/d7c71113c6c13047fb79e7d120173b78.webp)
...
![根据消息类型实现不同优先级的消息队列](./img/56ec510f7f7d4738e9db83dbd51f3fce.webp)
...
![动态调度策略](./img/3cc95247daae7f90f0dced017d349af5.webp)
...
首先我们来看看**页面加载**阶段的场景，在这个阶段，用户的最高诉求是在尽可能短的时间内看到页面，至于交互和合成并不是这个阶段的核心诉求，因此我们需要调整策略，在加载阶段将页面解析，JavaScript 脚本执行等任务调整为优先级最高的队列，降低交互合成这些队列的优先级。
...
![VSync 时钟周期和渲染引擎生成图片不同步问题](./img/1c3a9d8a0f56b73331041ea603ad3738.webp)
...
![绑定 VSync 时钟同步周期和浏览器生成页面周期](./img/06206ed4846e9531351a0cb7d1db6208.webp)

上面其实是非常粗略的介绍，实际实现过程也是非常复杂的，如果感兴趣，你可以参考这篇文章。（`https://docs.google.com/document/d/16822du6DLKDZ1vQVNWI3gDVYoSqCSezgEmWZ0arvkP8/edit`）
