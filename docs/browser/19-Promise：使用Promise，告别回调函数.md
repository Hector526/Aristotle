...
![Web 应用的异步编程模型](./img/01e40e30db7e8a91eb70ce02fd8a6985.webp)
...
![封装请求过程](./img/83dd5231c2e36c636c61af6a6dc80a5c.webp)
...
![回调函数返回值穿透到最外层](./img/efcc4fcbebe75b4f6e92c89b968b4a7f.webp)
...
之所以出现这个错误，是由于 Bromise 的延迟绑定导致的，在调用到 `onResolve_` 函数的时候，Bromise.then 还没有执行，所以执行上述代码的时候，当然会报“onResolve\_ is not a function“的错误了。
