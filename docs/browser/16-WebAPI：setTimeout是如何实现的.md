...
在上一篇文章中我们介绍了页面中的事件和消息队列，知道了浏览器页面是由消息队列和事件循环系统来驱动的。
...
![长任务导致定时器被延后执行](./img/1adf4da8ca4315cfb565e798649bd74f.webp)
...
![循环嵌套调用 setTimeout](./img/cbb3b2b1ac8eb4752a585df5445412cd.webp)
