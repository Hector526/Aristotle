...
我们一起看下，Chrome 打开一个页面需要启动多少进程？你可以点击 Chrome 浏览器右上角的“选项”菜单，选择“更多工具”子菜单，点击“任务管理器”，这将打开 Chrome 的任务管理器的窗口，如下图：

![Chrome 的任务管理器窗口](./img/ce7f8cfe212bec0f53360422e3b03a9e.webp)
...
![单线程与多线程的进程对比图](./img/3380f0a16c323deda5d3a300804b95da.webp)
...
![线程之间共享进程中的数据示意图](./img/d0efacd7f299ed99e776cb97da2a799e.webp)
...
![单进程浏览器架构示意图](./img/6ddad2419b049b0eb2a8036f3dfff1ca.webp)

如此多的功能模块运行在一个进程里，是导致单进程浏览器**不稳定、不流畅和不安全的**一个主要因素。下面我就来一一分析下出现这些问题的原因。
...
![早期 Chrome 进程架构图](./img/cdc9215e6c6377fc965b7fac8c3ec960.webp)
...
![最新的 Chrome 进程架构图](./img/b61cab529fa31301bde290813b4587fc.webp)
...
![Chrome“面向服务的架构”进程模型图](./img/329658fe821252db47b0964037a1de2a.webp)
...
![在资源不足的设备上，将服务合并到浏览器进程中](./img/a9ba86d7b03263fa3997d3733d958176.webp)

## 总结

主要是从 Chrome 进程架构的视角，分析了浏览器的进化史。
