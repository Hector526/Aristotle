...
![执行上下文中的 this](./img/b398610fd8060b381d33afc9b86f988d.webp)
...
关于 new 的具体细节你可以参考这篇文章（<https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Operators/new>），这里我就不做过多介绍了。
